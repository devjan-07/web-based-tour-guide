...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean isManagementEndpoint(String uri) {
        return uri.startsWith("/api/destinations")
                || uri.startsWith("/api/packages")
                || uri.startsWith("/api/accommodations")
                || uri.startsWith("/api/tour-guides")
                || uri.startsWith("/api/vehicles");
    }
}
